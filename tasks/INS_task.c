...
//#include "calibrate_task.h"  // 已移除: get_control_temperature() 现定义于 bsp_imu_pwm.c
...
void INS_task(void const *pvParameters)
{
    ...
    PID_init(&imu_temp_pid, PID_NORMAL, imu_temp_PID, TEMPERATURE_PID_MAX_OUT, TEMPERATURE_PID_MAX_IOUT, 0.0f, 0.0f);
...
static void imu_temp_control(fp32 temp)
{
    ...
    if (first_temperate)
    {
        PID_calc(&imu_temp_pid, temp, get_control_temperature(),0);
