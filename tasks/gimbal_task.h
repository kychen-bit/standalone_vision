...
#define PITCH_SPEED_PID_KP        300.0f// 29000.0   3000
#define PITCH_SPEED_PID_KI        0.0f
#define PITCH_SPEED_PID_KD        30.0f
#define PITCH_SPEED_PID_MAX_OUT   30000.0f
#define PITCH_SPEED_PID_MAX_IOUT  10000.0f

//yaw speed close-loop PID params, max out and max iout
//yaw 速度环 PID参数以及 PID最大输出，积分输出
#define YAW_SPEED_PID_KP        300.0f //3600
...
#define PITCH_GYRO_ABSOLUTE_PID_KP 1200.0f//15
#define PITCH_GYRO_ABSOLUTE_PID_KI 0.0f
#define PITCH_GYRO_ABSOLUTE_PID_KD -35.0f
...
#define YAW_GYRO_ABSOLUTE_PID_KP        600.0f  //26
...
#define YAW_ENCODE_RELATIVE_PID_KP        600.0f
...
#define YAW_MOUSE_SEN   0.0000005f
#define PITCH_MOUSE_SEN 0.0000015f
...
typedef struct
{
    ...
    uint16_t offset_ecd;
		int16_t ecd_angle; //计算角度差值
    fp32 max_relative_angle; //rad
    fp32 min_relative_angle; //rad
    fp32 max_absoulate_angle; //rad
    fp32 min_absoulate_angle; //rad
		fp32 trans_angle;
